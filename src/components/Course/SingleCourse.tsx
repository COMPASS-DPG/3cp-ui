...
const SingleCourse = ({
  ...
  const { courseName, rating, author, credit } = course;
      ...
      <div className='flex gap-4'>
        ...
        <div className='flex flex-grow flex-col justify-between'>
          ...
          <div className='flex justify-between '>
            <div className='flex items-center gap-2'>
              <FaUserEdit />
              <p className='text-[14px] font-medium text-[#272728]'>{author}</p>
              <ColoredText
                text='English'
        ...
        <div className='relative flex flex-col items-end justify-between'>
          ...
          <div className='rounded-lg bg-[#FFECAA] px-2.5 py-0.5'>
            <p className='text-[16px] font-bold text-[#272728]'>Cr.{credit}</p>
          </div>
          {/* course icon */}
          {showPopUp && (
            <div
            ...
            >
              <div className='flex flex-col p-2'>
                <div className='flex items-center gap-2 border-b border-[#E3E7EF] py-1'>
                  <BsFillPencilFill /> Edit Course
                </div>
                <div className='flex items-center gap-2 border-b border-[#E3E7EF] py-1'>
                  <BiSolidArchiveIn />
                  {activeComponenet === 'archivedSection'
                    ? 'Unarchive Course'
                    : 'Archive Course'}
                </div>
